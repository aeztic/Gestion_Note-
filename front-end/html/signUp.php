<?php 
include('../../back-end/configues/configSignUp.php');
?>
            ...
            <div class="form signup">
                ...
                <form id="signupForm" method="post">
                    <div class="input-field">
                        <input name="signupName" id="signupName" type="text" placeholder="Enter your username"
                            value="<?php if(isset($firstName)) echo $firstName; ?>">
                        <i class="uil uil-user"></i>
                    </div>
                    <span style="color: red;"><?php echo $firstNameErrorMsg; ?></span>
                    <div class="input-field">
                        <input name="signupEmail" id="signupEmail" type="text" placeholder="Enter your email"
                            value="<?php if(isset($email)) echo $email; ?>">
                        <i class="uil uil-envelope icon"></i>
                    </div>
                    <span style="color: red;"><?php echo $emailErrorMsg; ?></span>
                    <div class="input-field">
                        <input name="signupPassword" id="signupPassword" type="password" class="password"
                            placeholder="Create a password">
                        <i class="uil uil-lock icon"></i>
                    </div>
                    <span style="color: red;"><?php echo $passwordErrorMsg; ?></span>
                    <div class="input-field">
                        <input name="confirmPassword" id="confirmPassword" type="password" class="password"
